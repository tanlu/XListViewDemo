...
public class Dialog4Activity extends BaseDialogActivity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView title2Txt = (TextView) findViewById(R.id.title2_txt);
		...
		title2Txt.setText(dialog.getTitle2());
		...
		if (StringUtil.isEmpty(title2Txt.getText().toString())) {
