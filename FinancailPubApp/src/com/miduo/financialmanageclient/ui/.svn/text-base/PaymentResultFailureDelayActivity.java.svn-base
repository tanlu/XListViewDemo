 ...
 *
 */
public class PaymentResultFailureDelayActivity extends GesterSetBaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_paymentfailuredelayresult);
		initView();
		initEvent();
		initData();
	}
	...
	protected void onResume() {
		...
		super.onResume();		
		MobclickAgent.onPageStart("支付失败结果，银行信息延迟"); //统计页面
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();		
		MobclickAgent.onPageEnd("支付失败结果，银行信息延迟"); //  
