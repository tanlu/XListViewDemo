...
public class InvestPlannFourActivity extends BaseActivity implements OnClickListener {
	private ImageView leftImg;
	private TextView titleTxt;
	private TextView rightTxt;
	private TextView next_txt;
	private RadioButton radio_btn0, radio_btn1, radio_btn2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_invest_plann_four);
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		MobclickAgent.onPageStart("如何投资第四题"); // 统计页面
		MobclickAgent.onResume(this); // 统计时长
		if (MyApplication.investBean != null) {
			Integer index = MyApplication.investBean.getCarefor();
			if (index != null) {
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPageEnd("如何投资第四题"); //
	...
	private void initEvent() {
		...
		radioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				MyApplication.investBean.setCarefor(index);
			}
		});		
	...
	public void onClick(View v) {
		...
		case R.id.next_txt:
			...
			Intent intent = new Intent(this, InvestPlannFiveActivity.class);
